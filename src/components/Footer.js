  ...
  return (
    <footer className="w-full flex flex-col items-center justify-center gap-4 px-4 py-8 bg-white/10 border-t border-white/20 shadow-inner backdrop-blur-md rounded-t-2xl mt-10 animate-fade-in">
      <div className="flex flex-wrap justify-center gap-4 mb-2">
        <a href="https://github.com/" target="_blank" rel="noopener noreferrer" className="rounded-full p-2 bg-white/10 hover:bg-fuchsia-500/20 transition-all duration-200 text-white shadow-md">
        ...
        <a href="https://linkedin.com/" target="_blank" rel="noopener noreferrer" className="rounded-full p-2 bg-white/10 hover:bg-fuchsia-500/20 transition-all duration-200 text-white shadow-md">
